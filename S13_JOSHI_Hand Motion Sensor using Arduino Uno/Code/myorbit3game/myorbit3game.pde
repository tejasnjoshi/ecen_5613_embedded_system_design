// PARTIAL CODE OBTAINED FROM ... OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/134*@* */
/* !do not delete the line above, required for linking your tweak if you re-upload */
//Sunshine the Video Game by Tim Stutts
//Serial Interface added by Tejas Joshi for Flex Resistor Control of the game via the Serial Port
...
//Draw performs actions in continuous loop
void draw()
{
  background (0);
